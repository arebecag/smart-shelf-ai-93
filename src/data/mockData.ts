...
export const mockHistory: HistoryItem[] = [
  {
    ...
    date: '2025-01-05',
    products: [mockProducts[0], mockProducts[1], mockProducts[3], aguaProducts[0], padariaProducts[0], padariaProducts[2]],
    avgScore: 78,
    status: 'published',
    region: 'Curitiba',
    campaign: 'Inverno',
  ...
  },
  {
    ...
    date: '2025-05-10',
    products: [mockProducts[2], mockProducts[4], mockProducts[5], mockProducts[6], açougueProducts[0], açougueProducts[2], padariaProducts[1], sucoProducts[0]],
    avgScore: 82,
    status: 'draft',
    region: 'Litoral',
  ...
  },
  {
    ...
    date: '2024-12-15',
    products: [mockProducts[0], mockProducts[3], mockProducts[4], mockProducts[14], mockProducts[15], aguaProducts[1], aguaProducts[2], sucoProducts[0], sucoProducts[1]],
    avgScore: 71,
    status: 'published',
    region: 'Interior',
    campaign: 'Verão',
  ...
  },
  {
    ...
    name: 'Páscoa 2025',
    date: '2025-04-18',
    products: [mockProducts[7], mockProducts[8], mockProducts[16], mockProducts[17], açougueProducts[1], açougueProducts[3], padariaProducts[3], padariaProducts[4]],
    avgScore: 79,
    status: 'published',
    region: 'Curitiba',
    campaign: 'Páscoa',
  ...
  },
  {
    ...
    date: '2025-06-05',
    products: [mockProducts[0], mockProducts[1], mockProducts[9], mockProducts[10], mockProducts[18], mockProducts[19], açougueProducts[4], açougueProducts[5], aguaProducts[0], sucoProducts[1]],
    avgScore: 80,
    status: 'published',
    region: 'SC',
    campaign: 'Inverno',
  ...
  },
  {
    ...
    date: '2025-06-21',
    products: [mockProducts[3], mockProducts[4], mockProducts[5], mockProducts[11], mockProducts[12], açougueProducts[0], açougueProducts[2], padariaProducts[0], padariaProducts[2], aguaProducts[1]],
    avgScore: 77,
    status: 'published',
    region: 'Interior',
  ...
  },
  {
    ...
    date: '2025-07-10',
    products: [mockProducts[0], mockProducts[2], mockProducts[6], mockProducts[13], mockProducts[14], mockProducts[20], mockProducts[21], açougueProducts[1], açougueProducts[3], padariaProducts[1], padariaProducts[3], sucoProducts[0]],
    avgScore: 83,
    status: 'published',
    region: 'Litoral',
    campaign: 'Férias',
